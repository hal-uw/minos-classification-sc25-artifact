...
$NCU_BASE -o lammps.csv ../src/lmp_kokkos_cuda_mpi -k on g 1 device 0 -sf kk -pk kokkos neigh half neigh/qeq full newton on -v x 16 -v y 8 -v z 12 -in in.reaxc.hns -nocite
