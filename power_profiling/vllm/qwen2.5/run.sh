...
APP_CMD="$SCRIPT_DIR/../latency.sh -m Qwen/Qwen2.5-7B-Instruct -g 1 -d float16 -i 2048 -o 128"
...
echo "Starting Qwen/Qwen2.5-7B-Instruct profiling with ROCProfiler..."
...
echo "All Qwen2.5 profiling runs completed."
