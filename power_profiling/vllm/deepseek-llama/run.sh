...
APP_CMD="$SCRIPT_DIR/../latency.sh -m deepseek-ai/DeepSeek-R1-Distill-Llama-8B -g 1 -d float16 -i 2048 -o 128"
...
echo "Starting DeepSeek R1 llama8b profiling with ROCProfiler..."
...
echo "All DeepSeekR1 llama8B profiling runs completed."
